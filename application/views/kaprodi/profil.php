<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body pb-2 pt-3">
            <h5 class="font-weight-bold text-dark">Profil Kepada Program Studi <?= $programstudi['nama_prodi']; ?></h5>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col">
                <div style="margin-top: 12px">
                    <div class="mb">
                        <a href="<?= base_url("kaprodi/profil/edit_profil") ?>" style="float: right; color: #4469d7;" class="btn  border border-primary font-weight-bold btn-sm"><i class="bi bi-pencil-square "></i> Edit Profile</a><br></br>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-5" style="margin: auto;">
            <div class="card shadow mb-4 pb-2">
                ...
                <div class="text-center">
                    <h6 class="font-weight-bold text-dark"><?= $profil['nama_kaprodi']; ?></h6>
                    <h6 class="font-weight-bold"><?= $profil['nip']; ?></h6>
                    <h6><?= $programstudi['nama_prodi']; ?></h6>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-5">
                            ...
                            <p class="font-weight-bold text-secondary"><?= $profil['nama_kaprodi']; ?></p>
                            <span>NIP </span>
