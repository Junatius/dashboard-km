<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('mentor/monprofil_mahasiswa'); ?>">Mahasiswa</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Laporan:</h6>
                        <a class="collapse-item" href="<?= base_url('mentor/monlaporan'); ?>">Laporan Mahasiswa</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?= base_url('mentor/profil'); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?= base_url('mentor/sertifikat'); ?>">
                    <i class="fas fa-fw fa-user"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $profil['nama_mentor']; ?></span>
