        ...
        <div class="row">
            ...
            <div class="col">
                <div style="margin-top: 12px">
                    <div class="mb">
                        <a href="<?= base_url("mentor/profil/edit_profil") ?>" style="float: right; color: #4469d7;" class="btn  border border-primary font-weight-bold btn-sm"><i class="bi bi-pencil-square "></i> Edit Profile</a><br></br>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-5" style="margin: auto;">
            <div class="card shadow mb-4 pb-2">
                ...
                <div class="text-center">
                    <h6 class="font-weight-bold text-dark"><?= $profil['nama_mentor']; ?></h6>
                    <h6 class="font-weight-bold"><?= $profil['personal_number']; ?></h6>
                    <h6><?= $instansi['alamat_instansi']; ?></h6>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-5">
                            ...
                            <p class="font-weight-bold text-secondary"><?= $profil['nama_mentor']; ?></p>
                            <span>Personal Number </span>
                            <p class="font-weight-bold text-secondary"><?= $profil['personal_number']; ?></p>
                            <span>Role</span>
