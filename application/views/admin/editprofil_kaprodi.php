<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body pb-2 pt-3">
            <h5 class="font-weight-bold text-dark">Edit Profil Kaprodi <?= $informasi_kaprodi['nama_prodi'];; ?></h5>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            ...
            <p style="padding-left: 40px; margin-top: -6px;">
                Change information about kaprodi on this page
            </p>
        </div>
    </div>
    ...
    <div class="card shadow mb-4 pb-2">
        ...
        <?= form_open_multipart('admin/monprofil_kaprodi/editprofil_kaprodi/' . $informasi_kaprodi['id_kaprodi']); ?>
        <form action="<?= base_url('admin/monprofil_kaprodi/editprofil_kaprodi/' . $informasi_kaprodi['id_kaprodi']); ?>" method="POST" class="col" style="padding-left: 21px; margin-left: -35px;">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="text" class="form-control" id="nama_lengkap"
                            name="nama_lengkap" value="<?= $informasi_kaprodi['nama_kaprodi']; ?>">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="text" class="form-control" id="nip"
                            name="nip" value="<?= $informasi_kaprodi['nip']; ?>">
                    </div>
                        ...
                        <select class="form-control" id="nama_role" name="nama_role">
                            ...
                            <?php foreach ($list_role as $role) : ?>
                                <option value="<?= $role['id_role']; ?>"
                                    <?= ($informasi_kaprodi['role_id_role'] == $role['id_role']) ? 'selected' : ''; ?>>
                                    <?= $role['nama_role']; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                        ...
                        <select class="form-control" id="program_studi" name="program_studi">
                            ...
                            <?php foreach ($list_programstudi as $programstudi) : ?>
                                <option value="<?= $programstudi['id_prodi']; ?>"
                                    <?= ($informasi_kaprodi['program_studi_id_prodi'] == $programstudi['id_prodi']) ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="text" class="form-control" id="email"
                            name="email" value="<?= $informasi_kaprodi['email']; ?>">
                    </div>

                    <div class="form-group col-4">
                        <label for="no_hp">No. HP</label>
                        <input type="text" class="form-control" id="no_hp"
                            name="no_hp" value="<?= $informasi_kaprodi['no_hp']; ?>">
                    ...
                    <div class="form-group col-4">
                        ...
                        <select class="form-control" id="jenis_kelamin" name="jenis_kelamin">
                            <option value="Laki - Laki" <?= (isset($informasi_kaprodi['jenis_kelamin']) && $informasi_kaprodi['jenis_kelamin'] == "Laki - Laki") ? "selected" : ""; ?>>Laki - Laki</option>
                            <option value="Perempuan" <?= (isset($informasi_kaprodi['jenis_kelamin']) && $informasi_kaprodi['jenis_kelamin'] == "Perempuan") ? "selected" : ""; ?>>Perempuan</option>
                        </select>
