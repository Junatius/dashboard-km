<div class="container-fluid">
    ...
    //Bagian DosPem / Mahasiswa

    $nama_dospem = [];
    $jumlah_mahasiswa = [];
    foreach ($dospem as $dspm) {
        // Check if the program has already been displayed
        if (!in_array($dspm['nama_dospem'], $nama_dospem)) {
            // Add the program name to the displayed array
            $nama_dospem[] = $dspm['nama_dospem'];
            $jumlah_mahasiswa[] = count($dspm['mahasiswa']);
        }
    }
    //End Bagian DosPem / Mahasiswa
    ...
    <!-- Donut Berdasarkan Program Kampus Merdeka -->
    <div class="row">
        <div class="col-lg-6">
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4" style="border-radius: 3px; border-left: .20rem solid #4e73df!important">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Berdasarkan Program Studi</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body mb-4">
                    <div class="chart-pie pt-2">
                        <canvas id="myChartProdi" style="width:100%;max-width:800px"></canvas>
                    </div>
                    <br>
                    <br>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card shadow mb-4" style="border-radius: 3px; border-left: .20rem solid #4e73df!important">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Berdasarkan Dosen Pembimbing yang Memiliki Mahasiswa</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body mb-4">
                    <div class="chart-pie pt-2">
                        <canvas id="mybarChartdospem" style="width:100%;max-width:800px"></canvas>
                    </div>
                    <br>
                    <br>
                </div>
    ...
    <!-- Script Donut Berdasarkan Program Studi -->
    <script>
        var xValues = <?php echo json_encode($namaprodi); ?>;
        console.log(xValues);

        var yValues = <?php echo json_encode($jumlahMhs); ?>;
        yValues = Object.values(yValues);
        console.log(yValues);
    ...
    <!--END Script Donut Berdasarkan Program Studi -->

    <!-- Script Donut Berdasarkan Dosen Pembimbing yang Memiliki Mahasiswa -->
    <script>
        var xValues = <?php echo json_encode($nama_dospem); ?>;
        var yValues = <?php echo json_encode($jumlah_mahasiswa); ?>;
        yValues = Object.values(yValues);

        var ctx = document.getElementById("mybarChartdospem");
        var mybarChartdospem = new Chart(ctx, {
            type: "bar",
            data: {
                labels: xValues,
                datasets: [{
                    label: 'Dosen Pembimbing',
                    backgroundColor: "#e6c4b9",
                    data: yValues
                }]
            },
    ...
    <!--END Berdasarkan Dosen Pembimbing yang Memiliki Mahasiswa -->
